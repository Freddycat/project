...
void SetupShaders() {
  ...
  // color
  glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(Cube), (void *)offsetof(Cube, color));
  glEnableVertexAttribArray(1);
  glVertexAttribDivisor(1, 1);
  // center
  glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, sizeof(Cube), (void *)offsetof(Cube, center));
  glEnableVertexAttribArray(2);
  glVertexAttribDivisor(2, 1); // center changes per instance
  // scale
  glVertexAttribPointer(3, 1, GL_FLOAT, GL_FALSE, sizeof(Cube), (void *)offsetof(Cube, size));
